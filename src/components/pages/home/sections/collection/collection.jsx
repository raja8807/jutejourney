    ...
    <>
      ...
      <CustomContainer>
        ...
        <small className={styles.txt}>
          With hundreds of colours, designs, sizes and options available,
          choosing your ideal bag may seem complicated. {/* <br /> */}
          Give us a call on <span>+91 {contactDetails.mobile} </span>
          or email <span>{contactDetails.email}</span> and we will ensure that
          we find you the perfect bag.
        </small>
        <br />
        <br />
      </CustomContainer>
